...
import { X, Search, ChevronDown, Copy, CheckCircle } from 'lucide-react';
...
export const ReceiveModal: React.FC<ReceiveModalProps> = ({ isOpen, onClose, assets, walletAddress }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      <div className="relative glass border border-white/10 rounded-xl p-6 w-[400px]">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-medium">Receive Assets</h3>
          <button
            onClick={onClose}
