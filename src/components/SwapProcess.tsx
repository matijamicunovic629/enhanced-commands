...
export const SwapProcess: React.FC<SwapProcessProps> = ({ onClose }) => {
  ...
  const [anonLogo, setAnonLogo] = useState('');
  ...
  useEffect(() => {
    ...
    const fetchLogos = async () => {
      try {
        ...
        // For ANON, use a placeholder since it might not be in CoinGecko
        setAnonLogo('https://via.placeholder.com/40/4A90E2/FFFFFF?text=ANON');
      } catch (error) {
      ...
      <div className="flex-1 bg-white/5 rounded-xl p-6">
        <div className="space-y-6">
          <div className="flex justify-between items-center p-4 bg-white/5 rounded-lg">
            ...
            <div className="flex items-center gap-3">
              <img 
                src={anonLogo || "https://via.placeholder.com/40/4A90E2/FFFFFF?text=ANON"}
                alt="ANON" 
                className="w-10 h-10"
                onError={(e) => {
                  (e.target as HTMLImageElement).src = "https://via.placeholder.com/40/4A90E2/FFFFFF?text=ANON";
                }}
              />
              <div>
        ...
        <>
          ...
          <div className="flex items-center gap-4 animate-pulse">
            ...
            <img 
              ...
              className="w-12 h-12"
              onError={(e) => {
                (e.target as HTMLImageElement).src = "https://via.placeholder.com/48/4A90E2/FFFFFF?text=ANON";
              }}
            />
          </div>
